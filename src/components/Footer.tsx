      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-4">Scharli</h3>
              <p className="text-gray-300 mb-4">
                Professional web development and design services. We create modern, 
                fast, and beautiful websites that drive results for your business.
              </p>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Madrid Time: <span id="madrid-time">--:--</span></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Scharli. All rights reserved.
            </div>
